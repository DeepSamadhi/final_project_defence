...
from books.views import book_details, BookEditView, BookDeleteView, my_books,my_borrowed_books, borrowed_books, book_borrow, book_create, book_returned   #, BookCreateView, book_delete, BookCreateView
