...
import accounts_manage.managers
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=50, unique=True, validators=[django.core.validators.MinLengthValidator(2)])),
            ...
            managers=[
                ('objects', accounts_manage.managers.LibraryUserManager()),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
